...
import css from "../styles/loginRobotShowCase.module.scss";
...
const LoginRobotShowCase: React.FC<{ extraCss?: CSSProperties }> = ({
  extraCss = {},
}) => {
  ...
  return (
    <LoginContext.Provider value={value}>
      <div id={css.loginRobot} data-type="showcase" style={extraCss}>
...
export default LoginRobotShowCase;
