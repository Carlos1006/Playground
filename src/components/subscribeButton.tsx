...
const SusbcribeButton: FC = () => {
  ...
  const resetOffset = (): void => {
    if (subscribeButton.current) {
      const { x, y }: Coordinates =
        subscribeButton.current.getBoundingClientRect();
      setOffset({ x, y });
    }
  };
  ...
  return (
    <>
      <div
        ref={subscribeButton}
        onClick={async (e): Promise<void> => onClick(e)}
        className={`
      ...
      >
        ...
        <div
          className={css.solid}
          onClick={async (e): Promise<void> => onSubscribe(e)}
        >
          <span>SUBSCRIBE</span>
        ...
        <input
          ...
          value={inputValue}
          className={css.input}
          onFocus={async (e): Promise<void> => onFocus(e)}
        />
      </div>
    </>
  );
